...
public class MoaToDegree extends Fragment {
    ...
    private MoaToDegreeBinding binding;
    ...
    public View onCreateView(
        ...
        binding = MoaToDegreeBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(MoaToDegree.this)
                        .navigate(R.id.action_MoaToDegree_to_MenuHome);
            }
        });
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (valeurMOA.isEmpty()) {
                        ...
                        if (calculBalistik.Calculate("MOA_TO_DEGREE")) {
