...
import com.chasseprecision.balstikconverter.databinding.DonateBinding;
...
public class Donate extends Fragment {
    ...
    public View onCreateView(
        ...
        binding = DonateBinding.inflate(inflater, container, false);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(Donate.this)
                        .navigate(R.id.action_Donate_to_MenuHome);
            }
        });
