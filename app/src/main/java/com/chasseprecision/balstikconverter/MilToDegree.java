...
import com.chasseprecision.balstikconverter.databinding.MilToDegreeBinding;


public class MilToDegree extends Fragment {

    private MilToDegreeBinding binding;
    ...
    public View onCreateView(
        ...
        binding = MilToDegreeBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(MilToDegree.this)
                        .navigate(R.id.action_MilToDegree_to_MenuHome);
            }
        });
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (valeurMIL.isEmpty()) {
                        ...
                        if (calculBalistik.Calculate("MIL_TO_DEGREE")) {
